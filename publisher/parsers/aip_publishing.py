                        ...
                        for affiliation_sup in author_span.find_all("sup"):
                            if (
                                ...
                                for sup_split_part in sup_text.split(","):
                                    if (
                                        affiliation_id := sup_split_part.strip()
                                    ) and affiliation_id.isdigit():
                                        affiliation_ids.append(affiliation_id)

                        authors.append(
                            Author(name=author_name, aff_ids=affiliation_ids)
                        )
        return authors
                ...
                if institution_a := affiliation_li.find("a", class_="institution"):
                    if (
                        ...
                        if id_sup := affiliation_li.find("sup"):
                            if (
                                affiliation_id := id_sup.text and id_sup.text.strip()
                            ) and affiliation_id.isdigit():
                                affiliations.append(
                                    Affiliation(
